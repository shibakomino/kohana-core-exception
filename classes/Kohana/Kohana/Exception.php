...
//            static::log($e);
            ...
            header(Header::$str_content_type_plain, true, 500);
    ...
    public static function response(\Exception $e)
    {
        try {
            ...
            $response->headers('Content-Type', static::$error_view_content_type . '; charset=utf-8');
